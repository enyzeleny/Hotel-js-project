...
function setAmt() {
   ...
   if (pckgType == 1) {
       tax.value = ((199 * parseInt(numofRooms.value)) * 12 / 100) + " (Euro)";
       totalamt.value = (199 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Euro)";;
   }
   else if (pckgType == 2) {
       tax.value = ((499 * parseInt(numofRooms.value)) * 12 / 100) + " (Euro)";
       totalamt.value = (499 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Euro)";;
   }
   else if (pckgType == 3) {
       tax.value = (1099 * parseInt(numofRooms.value)) * 12 / 100 + " (Euro)";
       totalamt.value = (1099 * parseInt(numofRooms.value)) + parseInt(tax.value) + "(Euro)";;
   }
   else if (pckgType == 4) {
       tax.value = (1599 * parseInt(numofRooms.value)) * 12 / 100 + " (Euro)";
       totalamt.value = (1599 * parseInt(numofRooms.value)) + parseInt(tax.value) + " (Euro)";
   }
...
function proccedToPayment() {
   ...
   {
       alert('Advance Booking of rooms allowed  !');
       window.reload();
   }
   else
   {   
